...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
      <Container className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="https://flowbite.com/" className="flex items-center space-x-3 rtl:space-x-reverse">
          <img src="/to-do.svg" className="h-8" alt="Flowbite Logo" />
        ...
        <div
          className={`items-center justify-between transition-all duration-300 overflow-hidden w-full md:flex md:w-auto md:order-1 md:opacity-100 
          ${
            isOpened
              ? 'opacity-100 translate-y-0 max-h-[200px]'
              : 'opacity-0 max-h-0 md:max-h-none md:opacity-100 md:translate-y-0'
          }`}
          id="navbar-sticky"
        >
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            <li>
              <Link
                to="https://kasidit.netlify.app/#skills"
                className="block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
              >
                Skills
              </Link>
